;(function($){
	//主题文件的图片包,把这里的 siteid 改成要自定义UI的客户的 siteid 即可；
	var siteid = "kf_9016";
	$.themesURI = "http://localhost/themes/"+siteid+"/images/";
})(nTalk);
;(function($, undefined){
...
/*			（6.8.2合版）去掉更多按钮
	...
	chatManageView.prototype = {
		...
		_create: function(){
			...
			this.headerName = $({tag:'span',style:$.STYLE_BODY+'width:150px;height:20px;line-height:20px;font-size:14px;color:#d4f1ff;font-weight:bold;position:absolute;left:20px;top:20px;'}).appendTo(this.headBody).html('PPmoney理财在线客服');
