...
(function($, undefined){
    ...
    $.Connection.TChat.prototype = {
        ...
        _roomConnect_count:0, //（2017.02.07）代表重新连接的次数。0 代表第一次，用于区分是否值第一次连接。
        startType: 0, // 2017-03 教育版，表示是否是邀请回话。
        initialize: function(options){
            ...
            this.options = $.extend({
                ...
                //兼容转换参数命名
                ["siteid", "settingid", "tchatmqttserver", "tchatgoserver", "serverurl", "machineID", "userid", "username", "sessionid", "destid", "resourceurl", "statictis", "htmlsid", "connectid", "userlevel", "disconnecttime", "mini", "chattype", "chatvalue", "edu_invisitid", "edu_visitid","usertag","userrank"],
        ...
        roomConnect: function(cTopic, cWillTopic, sTopic, settingId){
            ...
            //教育版在最后添加邀请参数 没有的话设为0;
            var str = '{inviteid:"'+this.options.edu_invisitid+'",visitid:"'+this.options.edu_visitid+'"}';
            // 2017.08.26 添加userrank,usertag
            this.connect.publish({
                method: "roomConnect",
                params: [this.options.userId, "", this.options.sessionId, this.options.targetId, this.options.machineID,this.options.deviceType,this.options.chatType, this.options.chatValue,this.options.userName,this.options.userLevel,this.options.settingId,this._roomConnect_count,this.startType,str, {"userrank":this.options.userrank,"usertag":this.options.usertag}]
            }, this.clientTopic);
             //2017.02.07  数组中增加一位，区别重新连接和第一次连接。
