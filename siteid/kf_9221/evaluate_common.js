...
//evaluateStyle_common.js

$.evaluateBaseInfo = {'evaluateTitle': 'Evaluation', 'submitButtonName': 'evaluate', 'closeButtonName': 'X'};
$.evaluateMobileBaseInfo = {'evaluateTitle': '', 'submitButtonName': 'evaluate', 'cancelButtonName': 'cancel'};
...
$.defaultStyle = {
    ...
    'nt-evaluation-title' : 'position: relative;top: 0px;left: 0px;width: auto;height: 30px;padding: 0px;margin: 0px;text-align: center;font-size: 14px;font-weight: bold;line-height: 30px;color: #000;background: #F2F2F2;border-bottom: 1px solid #ccc;',

    'nt-evaluation-close' : 'position: absolute;top: 3px;right: 20px;font-size:14px;color:#000;cursor:pointer;',

    'nt-evaluation-question' : 'position: relative;top: 0px;left: 0px;width: auto;height: 30px;padding: 0px;margin: 0px;text-align: left;font-size: 12px;line-height: 30px;color: #5a5a5a;background: #FFF;',

    'nt-evaluation-radio-option' : 'position: relative;display: inline-block;*display: inline;*zoom:1;width: auto;height: 20px;padding: 0px;margin:0px 2px 0px 0px;text-align: center;background: #FFF;cursor:pointer',

    'nt-evaluation-radio-content' : 'position:relative;left:1px;font-size: 12px;line-height: 12px;color: #434343;',

    'nt-evaluation-radio-checked' : 'position:relative;top:2px;margin-right:0px',

    'nt-evaluation-section' : 'position: relative;top: 0px;left: 0px;width: 100%;height: auto;padding: 0px;margin: 0px 0px 0px 10px;text-align: left;background: #FFF;font-size: 0px;',

    'nt-evaluation-textarea-option' : 'position: relative;top: 0px;left: 0px;width: 100%;height: auto;padding: 0px;margin: 0px 0px 20px 0px;text-align: left;background: #FFF;font-size: 0px;',

    'nt-evaluation-textarea' : 'position: relative;width: 350px;height: 52px;padding: 10px;margin: 0px;text-align: left;font-size: 12px;line-height: 12px;color: #000;background: #FFF;border: 1px solid #cdcdcd;border-radius: 5px;box-sizing: content-box;resize:none',

    'nt-evaluation-textarea-length' : 'position:absolute;right:32px;top:72px;float:right;font-size:14px;font-weight:bold;color:#ccc;',

    'nt-evaluation-bottom' : 'position: relative;top: 5px;left: 0px;width: 100%;height: 42px;text-align: center;background:#FFF;border-radius: 5px;cursor:pointer',

    'nt-evaluation-bottom-button' : 'padding: 0px 15px; border: 1px solid rgb(135, 135, 135); height: 28px; color: rgb(51, 51, 51); line-height: 24px; display: inline-block; background: -webkit-gradient(linear, 0% 100%, 0% 0%, from(rgb(255, 255, 255)), to(rgb(245, 245, 245))) rgb(235, 233, 233);',

    'nt-evaluation-error' : 'position:relative; top:-68px; left:10px; width:auto; height:0px; line-height:30px; font-size:12px; color:red;display:none'
};
...
$.defaultMobileStyle = {
    ...
    'nt-evaluation-wrapper' : 'position: relative;top:-18px;left:0px;z-index:100000;width:100%;height:auto;background:#fafafa;',

    'nt-evaluation-section' : 'position: relative;top: 0px;left: 0px;width: 80%;height: auto;padding: 3% 0 0 0;margin: 0% 10% 0% 10%;font-size: 0px;text-align: center;background: #fbfbfb;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-tap-highlight-color:rgba(0,0,0,0);',

    'nt-evaluation-question' : 'position: relative;top: 0px;left: 0px;width: auto;height: auto;padding: 0px;margin: 0px;text-align: left;font-size: 14px;font-weight:bold;line-height: 30px;color: #333333;background: transparent;word-break:normal',

    'nt-evaluation-radio-option' : 'position: relative;display: block; width: 100%; height: 35px;',
    ...
    'nt-evaluation-radio-content' : 'position: relative;margin: 0px 0px 0px 15px; font-size: 14px; display: inline; color: #333; background-color: transparent;',

    'nt-evaluation-radio-unchecked' : 'position:absolute;left:20px;top:-1px;width:20px;height:20px;background:white;border: 1px solid #cecece;border-radius:10px;-webkit-border-radius:10px;-o-border-radius:10px;-moz-border-radius:10px;-ms-border-radius:10px',

    'nt-evaluation-radio-checked' : 'position: absolute; left: 22px; top: 1px; width: 16px; height: 16px; border: 1px solid rgb(50, 168, 245); border-radius: 8px; display: block; background: rgb(50, 168, 245);',

    'nt-evaluation-textarea-option' : 'position: relative;top: 0px;left: 0px;width: 100%;height: auto;padding: 0px;margin: 0px;text-align: left;background: #FFF;font-size: 0px;',

    'nt-evaluation-textarea' : 'position: relative;width: 88%;height: 52px;padding: 10px 6%;margin: 0px;text-align: left;font-size: 12px;line-height: 12px;color: #000;background: #FFF;border: 1px solid #cdcdcd;border-radius: 5px;box-sizing: content-box;resize:none',
    ...
    'nt-evaluation-bottom' : 'position: relative;top: 0;left: 0px;bottom: 0px;width: 100%;height: 2rem;line-height: 2rem;padding: 0px;margin: 0px;font-size: 0px;text-align: center;background: #fafafa;border-top: 1px solid #ddd;border-radius:5px;',

    'nt-evaluation-bottom-submit' : 'display: inline-block;width: 49%;font-size:14px;color: #55b6f5;',

    'nt-evaluation-bottom-cancel' : 'display: inline-block;width: 49%;font-size:14px;color: #55b6f5;border-right: 1px solid #ddd;'
};

$.defaultEffect = {
    'nt-evaluation-radio-content': {
        'checked' : {
            'color' : 'rgb(50, 168, 245)'
        },
