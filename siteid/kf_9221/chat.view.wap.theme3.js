(function($, undefined) {
    ...
    chatView.prototype = {
        ...
        createEvaluation: function(formOptions, title, startColor, endColor, callback) {
            var self = this,
                dialogElement;
            //2016.05.25 更改字体的显示顺序2017.02.23注释掉该功能。
        ...
        _getMessageHtml: function(type, data) {
            ...
            return type === 'right' ? [ //发送的消息
                    ...
                    (data.type == 2 ? ['<td style="', $.STYLE_NBODY, 'vertical-align:top;width:49px;_width:49px;height:auto;min-height:49px;position:relative;">',
                        ...
                        '</div>',
                        '</td>'
                    ].join("") : ['<td style="', $.STYLE_NBODY, 'vertical-align:top;width:49px;_width:49px;height:auto;min-height:49px;position:relative;">',
            ...
            return type == 'load' ? [
                ...
                type == 'bottom' ? [
                    ...
                    (
                        ...
                        ($.Audio && $.Audio.support() ? '<div class="chat-view-window-audio" style="' + $.STYLE_NBODY + 'position:relative;display:none;-webkit-tap-highlight-color:rgba(0,0,0,0);">' + '<div class="chat-view-button-text" style="' + $.STYLE_NBODY + 'width:32px;height:32px;position:absolute;left:45px;top:5px;cursor:pointer;background:url(' + $.jianpan_image + ') no-repeat;background-size:cover;">' +
                    ...
                    '<div class="chat-view-window-editor" style="', $.STYLE_NBODY, 'position:relative;display:block;">', (
                        (this.mode.options.config.robot_version == 2) ?
                        (($.Audio && $.Audio.support()) ?
                            '<div class="chat-view-button-audio" style="' + $.STYLE_NBODY + 'width:32px;height:32px;position:absolute;top:5px;left:45px;cursor:pointer;background-image:url(' + $.audio_image + ');background-repeat:no-repeat;background-size:cover;-webkit-tap-highlight-color:rgba(0,0,0,0);">' +
                        ...
                        ['<textarea placeholder="', $.lang.default_textarea_text, '" style="', $.STYLE_BODY, 'background:#fff;height:17px;line-height:17px;width:100%;resize:none;outline:none;padding:10px 0 10px 5px;border:1px solid #d4d4d4;border-radius:5px"></textarea>',
                            ...
                            '<span style="text-indent:-5px;width:36px;height:32px;font-size:12px;line-height:52px;color:#696d6c;display:inline-block;transform:scale(0.8,0.8);-ms-transform:scale(0.8,0.8);-moz-transform:scale(0.8,0.8);-webkit-transform:scale(0.8,0.8);-o-transform:scale(0.8,0.8);">' + $.lang.button_wap_switch_manual + '</span>',
                            '</div>'
                        ].join("") :
                        (($.Audio && $.Audio.support()) ?
                            '<div class="chat-view-button-audio" style="' + $.STYLE_NBODY + 'width:32px;height:32px;position:absolute;top:5px;left:5px;cursor:pointer;background-image:url(' + $.audio_image + ');background-repeat:no-repeat;background-size:cover;-webkit-tap-highlight-color:rgba(0,0,0,0);">' +
                        ...
                        ['<textarea placeholder="', $.lang.default_textarea_text, '" style="', $.STYLE_BODY, 'background:#fff;height:17px;line-height:17px;width:100%;resize:none;outline:none;padding:10px 0 10px 5px;border:1px solid #d4d4d4;border-radius:5px"></textarea>',
                            '</div>',
                            '</div>',
                            '<div class="chat-view-switch-manual" title="', $.lang.button_wap_switch_manual, '" style="' + $.STYLE_BODY + 'background:url(' + $.rengong + ') no-repeat center -6px;background-size:30px 30px;width:36px;height:36px;margin:10px 0px;position:absolute;right:10px;top:0px;text-align:center;cursor:pointer">',
                            '<span style="text-indent:-5px;width:36px;height:32px;font-size:12px;line-height:52px;color:#696d6c;display:inline-block;transform:scale(0.8,0.8);-ms-transform:scale(0.8,0.8);-moz-transform:scale(0.8,0.8);-webkit-transform:scale(0.8,0.8);-o-transform:scale(0.8,0.8);">' + $.lang.button_wap_switch_manual + '</span>',
                            '</div>'
                        ].join("")
                    ),
    ...
    chatManageView.prototype = {
        ...
        _create: function() {
            ...
            this.header = $({
                ...
                style: $.STYLE_NBODY + 'width:99.9%;height:' + header_title_height + 'px;position:absolute;left:0;top:' + ($.browser.weibo || $.browser.micromessenger ? '10%' : '0') + ';z-index:999;float:left;'
            ...
            var backButtonHtml = [
                ...
                //2016.04.7更改成为符号
                '<div style="line-height:20px;height:20px;width:20px;font-size:20px;padding:5px;font-family:iconfont;color:' + return_color + '">' + return_style + '</div></div>'
            ].join("");
            /* '<svg width="32" height="32">',
            ...
            var closeButtonHtml = [
                ...
                //2016.04.7
                '<div style="line-height:20px;height:20px;width:20px;opacity:1;font-size:20px;padding:5px;font-family:iconfont;color:' + close_color + '">' + close_style + '</div></div>'
            ].join("");
            /*'<svg width="32" height="32">',
                '<circle cx="16" cy="16" r="15" fill="#FFF" style="fill-opacity:0.7"></circle>',
            ...
            var iphoneButtonHtml = [
                '<div class="chat-view-window-header-iphone" style="position:absolute;width:30px;height:30px;z-index:50;border-radius:15px;right:60px;top:12px;display:block;overflow:hidden;">',
                   ' <a href="javascript:;" style="display:block;"><img width="30" height="30" src="'+$.sourceURI+'images/mobile/phone_wap.png" style="border:none;outline:none;"/></a>',
                '</div>'
            ].join('');*/
            //2016.04.15
            ...
            this.header.find('.chat-view-window-header-back').tap(function(event) {
                ...
                if ($.params.iframechat == "1" || $.mobileOpenInChat) {
                    self._callEndSession(false, true, 1);
                } else {
