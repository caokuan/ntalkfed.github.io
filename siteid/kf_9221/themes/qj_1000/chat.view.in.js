			...
			return type=='load' ?
				...
				[
					...
					'<div class="chat-view-window-toolbar" style="',$.STYLE_BODY,'height:28px;width:100%;border-top:1px solid #ffffff;background:#ffffff;">',
						...
						'<div class="chat-view-button chat-view-face" title=',$.lang.button_face,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:3px 0 3px 6px;_margin-left:5px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -98px 2px;padding:2px;">',
							'<div class="chat-view-hidden-area" style="',$.STYLE_NBODY,'width:0px;height:0px;position:relative;overflow:visible;">',
						...
						'</div>',
						//2016 更改图标padding 值
						'<div class="chat-view-button chat-view-image" title=',$.lang.button_image,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 6px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -120px 2px;padding:2px;"></div>',
						'<div class="chat-view-button chat-view-file" title=',$.lang.button_file,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 6px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -140px 2px;padding:2px;"></div>',
						//2016.03.21更改位置
						...
						/*'<div class="chat-view-capture-options" style="',$.STYLE_BODY,'color:#525252;float:left;margin:8px 0 4px 0px;border:0px solid #ccc;height:16px;display:inline-block;cursor:pointer;">',
							...
							'</div>',
						'</div>',*/
						'<div class="chat-view-button chat-view-evaluate" title=',$.lang.button_evaluation,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 6px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -180px 2px;padding:2px;"></div>',
					...
					/*	'<div class="chat-view-options" style="',$.STYLE_BODY,'margin:6px 10px 6px 0;float:right;border:1px solid #ccc;width:14px;height:26px;line-height:25px;text-align:center;cursor:pointer;">',
							...
							'</div>',
						'</div>',*/
						'<div class="chat-view-submit" style="',$.STYLE_BODY,'margin:4px 0;float:right;width:auto;height:26px;line-height:26px;text-align:center;padding:0 25px;border:1px #CCC solid;border-right:none;cursor:pointer;">'
						//2016.03.22更改固定字体
						,'\u53d1\u9001\u0028\u0053\u0029',
						'</div>',
						//2016.03.10 修改背景颜色' ,$.lang.button_end_session,'
						'<span class="chat-view-end-session" style="',$.STYLE_BODY,'text-decoration:none;margin:4px 10px 8px 0;padding:0 10px;float:right;height:24px;line-height:24px;cursor:pointer;background-color:#f3f3f3;">\u7ed3\u675f\u5bf9\u8bdd</span>',
						//2016.03.22修改颜色
	...
	$.chatManageView.prototype = {
		...
		_create: function(){
			...
			this._objView.buttonClose.hover(function(){
				//$(this).css('background-position', '-60px -20px');
				//2016.03.15
				$(this).css('background-color','#d82929');
			}, function(){
				//$(this).css('background-position', '-60px 0');
				$(this).css('background-color','');
			...
			this.headBody = $({className: 'chat-header-body', style: $.STYLE_BODY + 'background:#ebe9e9;z-index:0;color:#525252;'}).appendTo(this.header, true).css({
				...
				'border-bottom': '0',
				'top': '0px',//IN
				'border-right': '1px solid #ff4d4d',//IN
			...
			this.headPic=$({tag: 'span', className:'chat-header-pic', style: $.STYLE_BODY + 'display:inline-block;margin:10px 0 0 14px;height:30px;width:117px;float:left;background:url('+ $.imageicon + ') no-repeat -304px -95px' }).appendTo(this.headBody).html('');
			//2016.03.11更改字体颜色和margin 值
			this.headName = $({tag: 'span', className:'chat-header-name', style: $.STYLE_BODY + 'color:#ebedec;margin:20px 0px 13px 6px;display:inline-block;font-size:12px;float:left;height:24px;line-height:24px;max-width:220px;visibility:hidden;overflow:hidden;cursor:auto;'}).appendTo(this.headBody);
...
/*				$({className: 'ntalker-button-close', style: $.STYLE_BODY + 'background:url(' + $.imageicon + ') no-repeat -80px 0;cursor:pointer;width:20px;height:20px;float:right;color:#fff;'}).appendTo(this.rightElement.find('.window-right-head')).hover(function(){
		...
		_callResize: function(args){
			...
			var rigthConentHeight = this.options.height - 323-24;
			//2016.03.21新添加
