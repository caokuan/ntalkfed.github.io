;(function($, undefined){
	...
	$.chatView.prototype = {
		...
		_create: function(){
         ...
         //2017.07.26 学为贵定制
          _xwg_special:function(){
          
          	var xwg_chat_view_window_bottom=this.contains.find('.chat-view-window-bottom');
            var xwg_chat_view_end_session=this.contains.find('.chat-view-end-session');
            var xwg_chat_view_submit=this.contains.find('.chat-view-submit');
          	var xwg_chat_view_window_history=$('.chat-view-window-history');
          	var xwg_chat_view_window_editor=$('.chat-view-window-editor').find('textarea');
            var xwg_body_chat_containter=$('.body-chat-containter');
            var xwg_chat_view_lbar=$('.chat-view-lbar');
            var xwg_view_fileupload_body=$('.view-fileupload-body');
            // xwg_view_fileupload_body.css({
			// 	'border-color':'#ffffff',
			// 	'border': '#f0f0f0'
            // });
            xwg_chat_view_window_editor.css({
            ...
            xwg_chat_view_window_history.css({
             	'background-color':'#ffffff',
             	'width':'453px'
             });
            xwg_body_chat_containter.css({
          	...
          	xwg_chat_view_window_bottom.css('background','#ffffff');
			xwg_chat_view_end_session.css({
				'margin':'8px 0 4px 0',
          	...
          	xwg_chat_view_submit.css({
				'margin':'8px 8px 0 6px',
				'background-color':'#d51323',
				'border':'solid 1px #d51323',
				'font-size':'13px',
				'height':'23px',
				'line-height': '23px',
				'border-radius':'4px',
		...
		_showFileUpload: function(liElement, bodyElement, data, type) {
			...
			//所需图标在大图中的位置
			//2016.03.30修改图片的位置
			var statusIconPosition = success ? ' -390px -219px ' : ' -392px -239px ';
			//显示状态名称
					...
					'<table style="',$.STYLE_NBODY,'float:right;_float:none;border-collapse:separate;" class="view-history-right" cellpadding="0" cellspacing="0" border="0" class="table">',
						'<tbody style="',$.STYLE_NBODY,'text-align:right;">',
							...
							//2016.03.11更改颜色更改border 顏色值 添加color 值if(data.type == 7) data.type = 1;
								'<td class="view-history-content" style="',$.STYLE_BODY,'padding:8px;background:#cdefff;border:1px solid #cdefff;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;">',
									...
									(data.type == 1 ? 'color:#' + data.color + ';font:'+(data.italic=="true" ? 'italic' : 'normal')+' '+(data.bold=="true" ? 'bold' : 'normal')+' ' + data.fontsize + 'px/160% Arial,SimSun;font-size:12px;color:#494949;text-decoration:' + (data.underline=="true" ? 'underline' : 'none') + ';' : ''),
									'">',
									(data.type==1 
									? data.msg 
									: data.type==6 
								...
								'<td style="',$.STYLE_NBODY,'width:10px;vertical-align:top;overflow:visible;">',
									...
									//尖角添加className
									'<div class="view-history-angle" style="',$.STYLE_NBODY,'position:relative;left:0px;top:8px;z-index:1;width:10px;height:18px;background:url(',$.imageicon,') no-repeat -1px -62px;"></div>',//
									
								'</td>',
								'<td style="',$.STYLE_NBODY,'width:54px;vertical-align:top;overflow:visible;">',
								//2016.03.31更改样式增加td//2016.03.18增加头像
								   '<div style="',$.STYLE_NBODY,'margin-right:20px;margin-left:10px;width:40px; height:40px; position:relative; bottom:0; background:url(',$.imageicon,') no-repeat -325px 0px; border-radius:50%;"></div>',
								'</td>',
							'</tr>',
							'<tr style="',$.STYLE_NBODY,'">',
								'<td style="',$.STYLE_BODY,'overflow:visible;text-align:right;position:relative;">',
								  '<span class="view-chat-hidden-area" style="',$.STYLE_NBODY,'width:1px;height:26px;overflow:visible;position:relative;top:0px;">',
										'<div class="view-history-status" style="',$.STYLE_BODY,'display:none;color:#010002;line-height:26px;width:280px;position:absolute;left:-280px;top:-17px;">',
											...
											'<div class="view-history-status-icon" style="',$.STYLE_NBODY,'margin:7px 3px;float:right;display:block;line-height:26px;width:10px;height:10px;background:#fff url(',$.imageicon,') no-repeat -139px -43px;"></div>',
										'</div>',
									'</span>',
								//2017.05.16 隐藏访客名称
                                    ...
                                    // '</span>',
								  //2016.03.11更改颜色
									'<span class="view-history-time" style="',$.STYLE_BODY,'padding-left:6px;color:#b6b6b6;line-height:26px;font-size:10px;">',$.formatDate(data.timerkeyid),'</span>',
						...
						'<tbody style="',$.STYLE_NBODY,'">',
							'<tr style="',$.STYLE_NBODY,'">',
							    '<td style="',$.STYLE_NBODY,'width:48px;height:40px;vertical-align:bottom;vertical-align:top;overflow:visible;">',
									...
									'<div class="view-history-div" style="',$.STYLE_NBODY,'float:left;margin-left:15px; -margin-left:14px;margin-right: 10px; width:40px; height:40px;'+(data.logo?' ':'background:url('+$.imageicon+') no-repeat -325px -47px;')+' display:inline-block; position:relative; top:0;border-radius:50%">',
							   ...
							   '<td style="',$.STYLE_NBODY,'width:10px;height:40px;vertical-align:bottom;vertical-align:top;overflow:visible;">',
									//2016.03.18更改垂直方向的位置
									//尖角添加className
									'<div class="view-history-angle" style="',$.STYLE_NBODY,'flaot:right;position:relative;top:8px;left:2px;z-index:1;display:inline-block;width:10px;height:18px;background:url(',$.imageicon,') no-repeat -30px -62px;"></div>',
								'</td>',
								'<td class="view-history-content" style="',$.STYLE_BODY,'padding:8px;background:#f0f0f0;border:1px solid #f0f0f0;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px">',
									...
									(data.type == 1 ? 'color:#' + data.color + ';color:#494949;font:'+(data.italic=="true" ? 'italic' : 'normal')+' '+(data.bold=="true" ? 'bold' : 'normal')+' ' + data.fontsize + 'px/160%' + ' Arial,SimSun;color:#494949;text-decoration:' + (data.underline=="true" ? 'underline' : 'none') + ';' : ''),
									'">',
							...
							'<tr style="',$.STYLE_NBODY,'">',
								...
								// 	''),
									...
									//2016.03.11更改颜色
									'<span class="view-history-time" style="',$.STYLE_BODY,'padding-left:6px;float:left;color:#b6b6b6;line-height:26px;font-size:10px;">',
										//客服输入状态消息不显示时间
		...
		_getViewHtml: function(type){
			...
			return type=='load' ?
				...
				[
					...
					'<div class="chat-view-window-toolbar" style="',$.STYLE_BODY,'height:28px;width:100%;border-top:1px solid #ffffff;background:#f0f0f0;">',
						//分配客服时状态消息
						//2017-05-16 xiu
						'<div class="chat-view-hidden-area" style="',$.STYLE_NBODY,'width:0px;height:0px;position:relative;overflow:visible;">',
							'<div class="chat-view-window-status-info" style="',$.STYLE_BODY,'background:#d51323;overflow:hidden;color:#fff;margin-left:10px;width:380px;line-height:30px;height:30px;position:absolute;top:-30px;z-index:99;text-align:center;display:none;"></div>',
						'</div>',
						...
						'<div class="chat-view-button chat-view-face" title=',$.lang.button_face,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:5px 0 4px 15px;_margin-left:5px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -102px 0;">',
							'<div class="chat-view-hidden-area" style="',$.STYLE_NBODY,'width:0px;height:0px;position:relative;overflow:visible;">',
						...
						'</div>',
						//2016 更改图标padding 值
						'<div class="chat-view-button chat-view-image" title=',$.lang.button_image,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 20px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -125px 0;"></div>',
						'<div class="chat-view-button chat-view-file" title=',$.lang.button_file,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 20px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -148px 0px;"></div>',
						//2016.03.21更改位置
						'<div class="chat-view-button chat-view-capture" title=',$.lang.button_captureImage,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 20px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -172px 0px;"></div>',
						/*'<div class="chat-view-capture-options" style="',$.STYLE_BODY,'color:#525252;float:left;margin:8px 0 4px 0px;border:0px solid #ccc;height:16px;display:inline-block;cursor:pointer;">',
							...
							'</div>',
						'</div>',*/
						'<div class="chat-view-button chat-view-evaluate" title=',$.lang.button_evaluation,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 20px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -196px 0px;"></div>',
						'<div class="chat-view-button chat-view-history" title=',$.lang.button_save,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 20px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -75px -107px;"></div>',
						...
						'<div class="chat-view-button chat-view-exp" style="',$.STYLE_BODY,'color:#9a9a9a;float:right;margin:5px 3px 4px 3px;padding:0 3px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;">',$.lang.button_more,' &gt;</div>',
					'</div>',
					//2016.03.11 更改高度和padding值 
					'<div class="chat-view-window-editor" style="',$.STYLE_BODY,'height:65px;width:100%;background-color:#ffffff;overflow:hidden;">',
						//2016.03.22更改固定文字 更改颜色
						'<textarea placeholder="\u6211\u8981\u62a5\u540d\u96c5\u601d\u002f\u6258\u798f\u8bfe\u7a0b\u2026\u2026" style="',$.STYLE_BODY,CON_STYLE_SHADOW,'margin:1px;padding:10px 5px 0 15px;width:391px;width:411px\\9;height:73px;height:93px\\9;outline:0px solid #08f;border:0px solid #08f;color:#9a9a9a;font-family:Arial;resize:none;overflow:hidden;"></textarea>',
					'</div>',
					...
					/*	'<div class="chat-view-options" style="',$.STYLE_BODY,'margin:6px 10px 6px 0;float:right;border:1px solid #ccc;width:14px;height:26px;line-height:25px;text-align:center;cursor:pointer;">',
							...
							'</div>',
						'</div>',*/
						'<div class="chat-view-submit" style="',$.STYLE_BODY,'margin:8px 0;margin-left: 6px;float:right;width:auto;height:26px;line-height:26px;text-align:center;padding:0 32px;border:1px #CCC solid;border-right:none;cursor:pointer;">'
						//2016.03.22更改固定字体
						,'\u53d1\u0020\u9001',
						'</div>',
						//2016.03.10 修改背景颜色' ,$.lang.button_end_session,'
						'<span class="chat-view-end-session" style="',$.STYLE_BODY,'border:1px solid #ebedec;color: #3b3b3b;text-decoration:none;margin:8px 10px 8px 0;padding:0 10px;float:right;height:24px;line-height:24px;cursor:pointer;background-color:#f3f3f3;">\u7ed3\u675f\u5bf9\u8bdd</span>',
						//2016.03.22修改颜色
						'<span class="chat-view-xiaoneng-version" style="',$.STYLE_BODY,'display:block;visibility:visible;text-decoration:none;margin:8px 0px 6px 15px;float:left;height:26px;line-height:26px;color:#9a9a9a;visibility:hidden;">\u5bf9\u65b9\u6b63\u5728\u8f93\u5165\u4fe1\u606f\u002e\u002e\u002e</span>',
		...
		_bind: function(){
			...
			this.textEditor = this.chatElement.find('.chat-view-window-editor textarea').css({
				...
				if( $.browser.msie && $.browser.ieversion<=7 ){
					...
					$(this).css({"outline-width": "0","color":"#9a9a9a"});
				}
				$(this).attr('placeholder','\u6211\u8981\u62a5\u540d\u96c5\u601d\u002f\u6258\u798f\u8bfe\u7a0b\u2026\u2026');
				self._stopListen();
			...
			this.chatElement.find('.chat-view-evaluate').click(function(event){
				...
				//2017.05.15 点击后样式
				$(this).css("background-position","-196px -21px");
			});
		...
		disableButton: function(buttonName, disable){
			...
			if( disable ){
				...
				if(selector.indexOf('chat-view-evaluate') > -1) {
					this.chatElement.find('.chat-view-evaluate').hover(function(event) {
						$(this).css({
	...
	$.chatManageView.prototype = {
		...
		updateChatTag: function(settingid, data, updateStatus){
			...
			this.leftContent.find('li.'+settingid+' .tag-head-icon').css('background-color', data.status!==1 ? '#666' : '#d51323');
			...
			signWidth = Math.max(0, this.header.width() - name.width() - 170);
		...
		toggleExpansion: function(attr, extend){
			...
			if($.evaluateStarLevel) {
				...
				var signWidth = Math.max(0, this.header.width() - name.width() - 170);
		...
		_create: function(){
			...
			this._objView.buttonClose.hover(function(){
				$(this).css({
					background: 'url(' + $.imageicon + ') no-repeat -62px -20px'
				})
			}, function(){
				$(this).css({
					background: 'url(' + $.imageicon + ') no-repeat -62px 1px'
				})
			...
			this._objView.buttonMax.hover(function(event){
				$(this).css({
					background: 'url(' + $.imageicon + ') no-repeat -30px -20px'
				})
			}, function(event){
				$(this).css({
					background: 'url(' + $.imageicon + ') no-repeat -30px 1px'
				})
			}).css({
				margin: '17px 5px',
				width: '20px',
			...
			this._objView.buttonMin.hover(function(){
				$(this).css({
					background: 'url(' + $.imageicon + ') no-repeat -4px -18px'
				});
			}, function(){
				$(this).css({
					background: 'url(' + $.imageicon + ') no-repeat -4px 1px'
				});
			}).css({
				margin: '17px 5px',
				width: '20px',
			...
			this.headBody = $({className: 'chat-header-body', style: $.STYLE_BODY + 'background:#ebe9e9;z-index:0;color:#525252;'}).appendTo(this.header, true).css({
				...
				'border-bottom': '0',
				'top': '0px',//IN
				'border-right': '1px solid #d51323',//IN
			...
			//2016.03.10 新增logo图片margin:5px 15px 5px 20px;
			
			this.headPic=$({tag: 'span', className:'chat-header-pic', style: $.STYLE_BODY + 'display:inline-block;height:40px;width:40px;position:absolute;top:5px;left:20px;background:url('+ $.imageicon + ') no-repeat -325px -93px' }).appendTo(this.headBody).html('');
			//2016.03.11更改字体颜色和margin 值
			this.headName = $({tag: 'span', className:'chat-header-name', style: $.STYLE_BODY + 'color:#ebedec;margin:19px 0 0 70px;display:inline-block;heigth:13px;color:#ffffff;font-size:12px;float:left;max-width:220px;visibility:hidden;overflow:hidden;cursor:auto;'}).appendTo(this.headBody);
			this.headSign = $({tag: 'span', className:'chat-header-sign', style: $.STYLE_BODY + 'color:#c3c3c3;margin:19px 0 0 10px;display:inline-block;float:left;height:20px;visibility:hidden;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;cursor:auto;'}).appendTo(this.headBody);
			//2016.03.10将图片进行隐藏
			...
			var iframeUrl = 'http://v.guixue.com/zhuanqu/xiaoneng' +'?'+ $.toURI({
				settingid: $.global.settingid
			});
			var pptElement_tem_height=452;
			this.pptElement = $({tag: 'iframe', className: 'window-right-pro-conent', style: $.STYLE_BODY + 'margin:8px 8px;width:' + (this.options.rightElementWidth-16) + 'px;background:#fff;height:'+ pptElement_tem_height+'px;overflow-x:hidden;overflow-y:hidden;'}).attr({
				//debug temp
				//别人提供的地址
		...
		_onOverChatTag: function(event){
			...
			$(target).find('.tag-button-close').css({
				background: 'url('+$.imageicon+') no-repeat -138px -42px'
			});
		...
		_callResize: function(args){
			...
			var rigthConentHeight = this.options.height - 16;
			//2016.03.21新添加
