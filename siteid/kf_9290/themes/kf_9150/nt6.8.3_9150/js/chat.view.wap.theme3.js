(function($, undefined) {
    ...
    $.beijing_image=$.sourceURI + 'images/wapTheme3/beijing.png';
    var newWapTheme = {
        title: "#ffffff",
        return_style: "&#xe619;",
        return_color: "#513727",
    ...
    var css=[
       '@font-face {',
        ...
        'src: url("./fontIcon/iconfont.eot?#iefix") format("embedded-opentype"),', /* IE6-IE8 */
        'url("./fontIcon/iconfont.woff") format("woff"),', /* chrome、firefox */
        'url("./fontIcon/iconfont.ttf") format("truetype"),', /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
         'url("./fontIcon/iconfont.svg#iconfont") format("svg");', /* iOS 4.1- */
        '}',
        '.iconfont{',
    ...
    chatView.prototype = {
        ...
        _create: function() {
            var self = this,
                ...
                var header_title_height='44';//头部的高度
            this.contains = $(document.body);
            ...
            this.chatElement = $({
                    ...
                    style: $.STYLE_BODY + 'width:100%;/*min-height:' + bodyHeight + 'px;*/display:none;overflow-y:scroll;position:absolute;top:0px;bottom:50px;padding-top:44px;-webkit-overflow-scrolling:touch;overflow-x:hidden;'+background_whole_exp+''
            ...
            this.messageElement = $({
                ...
                style: $.STYLE_BODY + 'width:100%;min-height:' + bodyHeight + 'px;display:none;position:absolute;top:'+header_title_height+'px;background-color:#F3F3F7;bottom:0px;-webkit-overflow-scrolling:touch;overflow-x:hidden'
        ...
        switchUI: function(type) {
            ...
            switch (type) {
                case this.mode.CON_VIEW_WINDOW:
                    ...
                    //2016.04.08 高度更改
                    this.contains.find('.chat-view-window-header').css('height', '44px').display(1);
                ...
                case this.mode.CON_VIEW_MESSAGE:
                    ...
                    this.contains.find('.chat-view-window-header').css('height', '44px').display(1);
                   //2016.04.11 更改
                   this.contains.find('.chat-view-window-header-title').display();
        ...
        showMessage: function(position, data) {
            ...
            //2015.11.01 调整背景颜色以及padding距离 2016.04.15更改padding值
            style = [
                $.STYLE_NBODY + 'list-style:none outside none;display:block;margin:0;padding:5px 0px 5px 0px;background:transparent',
                $.STYLE_NBODY + 'list-style:none outside none;display:block;margin:0;padding:5px 0px 5px 0px;background:transparent',
                $.STYLE_NBODY + 'list-style:none outside none;display:block;margin:0;padding:5px 0px 5px 0px;text-align:center;background:transparent'
            ];
            ...
            if (data && /^(1|2|4|6|13)$/i.test(data.type)) {
        ...
        updateMessage: function(msgid, type, data, receive) {
            var self = this,
             ...
             //2016.04.06bububble #CEF2FF 图片的气泡颜色  需要更改配置bubble
                        ...
                        if (type == 2) { //图片
                            $.require(data.url + '#image', function(image) {
                                if (image.error) {
                                    ...
                                    bodyElement.css({
                                        'background': 'url(' + $.imageicon + ') no-repeat -435px -6px'
                                    });
                                    ...
                                    var dest = $.base.checkID(liElement.attr('userid')) <= 1,
                                        ...
                                        //2016.04更改border 值
                                        border = (dest && userid) ? '#ffffff' : bubble;
                                        img_border=(dest && userid) ? '#ffffff' : bubble;
                                    bodyElement.css({
                                        'border': '1px solid ' + border,
                                        'padding': '0px',//2016.04.11更改padding值
                                        'background': backgroundColor,
                                        'cursor': 'pointer',
                                        'height': attr.height + 'px'
                                    }).html('<img src="' + data.url + '" sourceurl="' + data.sourceurl + '" width="' + attr.width + '" height="' + attr.height + '" style="' + $.STYLE_NBODY + 'vertical-align:middle;border:solid 1px #ffffff;border-color:'+img_border+';border-radius:10px;-webkit-border-radius: 10px;-moz-border-radius: 10px;-ms-border-radius: 10px;" />').find('img').tap(function(event) {
        ...
        viewLinkContainer: function(data, selector) {
            ...
            $({className:'link-customer', style: $.STYLE_BODY + 'margin:5px 0 10px 0;width:100%;max-height:60px;overflow:hidden;'}).appendTo( container ).html( data.customer );
            $({
        ...
        suggest: function(data) {
            ...
            $.each(data, function(i, message) {
                $({
                    ...
                    talk_index: i,
                    className: '',
                    style: CON_STYLE_PUBLIC_CONTENT + 'padding:0 0 0 20px;list-style:none;line-height:28px;height:28px;overflow:hidden;cursor:pointer;'
        ...
        showInputState: function(position) {
            ...
            $({tag: 'span', style: 'display:block; left: -24px; top:-20px; position:relative; width:20px; height:20px; background: url(' + $.imageicon + ') -110px -70px no-repeat'}).appendTo(elementWait);
        ...
        _showCompress: function(msgid) {
            ...
            bodyEl.css({
                'background': 'url(' + $.imageicon + ') no-repeat -350px -6px',
                'border': 'none'
            });
        ...
        _outTimeResend: function(msgid) {
            ...
            bodyEl.css('background-position', '-435px -6px');
        ...
        _showFailure: function(msgid, eType) {
            ...
            return bodyElement.css('background', 'url(' + $.imageicon + ') -435px -6px transparent');
        },
        ...
        createEvaluation: function(formOptions, title, startColor, endColor, callback) {
            var self = this,
                dialogElement;
                //2016.05.25 更改字体的显示顺序
            for(var m=0;m<formOptions.length-1;m++){
               formOptions[m].options=formOptions[m].options.reverse();
            }
                ...
                html = [
                    ...
                    */
                    ...
                    //6.1.7.2 按钮位置变更
                    '<span style="', $.STYLE_NBODY, 'display:inline-block;width:49%;text-align:center;padding:2px 0 10px 0;">',
                    '<input type="button" class="ntkf-alert-cancel" value="' + $.lang.evaluation_button_cancel + '" style="', $.STYLE_BODY, 'text-align:center;width:72px;color:#a6a6a6;font:normal 14px/28px Arial,SimSun;background:#ffffff;border:solid 1px #cccccc;-webkit-appearance: none;border-radius: 5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;-o-border-radius: 5px; -ms-border-radius: 5px;margin-left:20%;" />',
                    '</span>',
                    '<span style="', $.STYLE_NBODY, 'display:inline-block;width:50%;text-align:center;padding:2px 0 10px 0;">',
                    '<input type="button" class="view-alert-submit" value="' + $.lang.evaluation_button_submit + '" style="', $.STYLE_BODY, 'text-align:center;width:72px;color:#ffffff;font:normal 14px/28px Arial,SimSun;background:#35a3f0;border:solid 1px #35a3f0;-webkit-appearance: none;border-radius: 5px;-webkit-border-radius: 5px;-moz-border-radius: 5px;-o-border-radius: 5px; -ms-border-radius: 5px;margin-right:20%;" />',
                    '</span>',
                    '</td></tr>',
                    '</table>'
                ].join('');
            ...
            var evaluationHeight = (self.options.length == 2 ? 316 : 410);
            var top = ($(window).height() - evaluationHeight) ;
            ...
            var wholeCss = {'width':'100%',
                            'border-radius':'0',
                            'left':'0'};

                //2016.05.10更改样式
              //苹果4屏幕高度为480px 下设置top 为0
                if( $.browser.iOS && $(window).height()<=500){
                setTimeout(function(){
                    dialogElement.css($.merge(wholeCss,{
                            'top':'0'
                            }));
                    },6);
                     //兼容苹果5
                }else if($.browser.iOS && $(window).height()>500 &&　$(window).height()<=570){
                    setTimeout(function(){
                    dialogElement.css($.merge(wholeCss,{
                            'top':'60px'
                            }));
            ...
            dialogElement.find('li').each(function(i, element) {
                if ($(element).find('input').length > 0) {
                    $(element).css({
                        ...
                        'height': ($(element).find('input[name=problem]').length > 0 ? '28px' : '54px'),
                        'color': '#d5d5d5'
                    });
                }
            });
            //2016.05.09 更改字体的高度
            dialogElement.find('input[type=radio][name=evaluation]').parent(3).find('div').eq(0).css({
            ...
            var problemRadio = dialogElement.find('input[type=radio][name=problem]');

            if(problemRadio && problemRadio.parent(3)){
                problemRadio.parent(3).find('div').eq(0).css({
                    'margin':'20px 0',
            ...
            dialogElement.find('textarea').parent().find('div').css({
                   'margin':'20px 0',
                   'padding':'7px 0px 7px 0px',
                   'background-color':'#f5f5f5',
                   'font-size':'12px',
            ...
            //2016.05.09添加图片
            $.chat_radio_item=['1.png','2.png','3.png','4.png','5.png'];
            ...
            dialogElement.find('input[type=radio]').css({
                ...
                $(element).parent().tap(function(event) {
                ...
                if (element.id.indexOf('problem_') == -1) {
                    ...
                    //2015.09.19 外心圆
                    $(element).parent().append('<div class="chat-radio-item" style="' + $.STYLE_NBODY + 'position:absolute;left:25%;top:0px;width:30px;height:29px;"><img src="'+$.sourceURI+'images/wapValuate/'+$.chat_radio_item[i]+'" style="width:30px;height:29px;"></div>');
                    //2015.09.19 内心圆
                    $(element).parent().append('<div class="chat-radio-checked" style="' + $.STYLE_NBODY + 'position:absolute;left:25%;top:0px;width:30px;height:29px;background-color:yellow;opacity:0.3;border-radius: 50%;-webkit-border-radius: 50%;-moz-border-radius: 50%;-o-border-radius:50%; -ms-border-radius: 50%;"></div>');
                }
            });

            //修正 "是否解决问题" 的样式
            problemElement = dialogElement.find('input[type=radio][name=problem]');
...
/*            dialogElement.find('table textarea').bind('keyup', function(event) {
        ...
        _selectedRadio: function(dialogElement, element) {
            ...
            inputElement.parent(2).find('li').each(function(i, element) {
                if ($(element).find('input').length) {
                    ...
                    $(element).find('label').css('color', '#d5d5d5');
                    ...
                    if ($(element).find('input').attr('id').indexOf('problem_') != -1) {
                       //2016.05.11更改颜色
                        ...
                        //2016.05.09修改当非常满意时全部显示
                        $(element).find('.chat-radio-checked').css('display', 'block');
                    }
                }
            });
            ...
            if (element.id.indexOf('problem_') != -1) {
                $(element).parent().find('label').css({
                    'color':'#FFFFFF',
                    'background-color':'#32a8f5',
                    'border-color':'#32a8f5'
                });

            } else {
                //2016.05.09
                $(element).parent().find('.chat-radio-checked').css('display', 'none');
                $(element).parent().find('label').css('color', '#7b7b7b');
            }
        },
        /**
        ...
        _fullScreenImage: function(image, msgid) {
            var self = this, hashMsgId, timeSub, hashTime,time,
            ...
            var loadingGifTimer = new $.GifTimer({
                ...
                inTimeFunc: function() {
                    this.options.x -= 32;
                    $('.big-image-loading').editBackgroundPosition({x:this.options.x});
        ...
        _createShowWebIframe: function(url) {
            ...
            //变更标题框
            //self.header.css({'background-color':'#32A8F5', 'height':'55px'});
        ...
        createMessageForm: function(formOptions, disable_message, announcement, data) {
            var self = this,
                i, html;
                //2016.04.20 修改公告栏的颜色
            var titlename=newWapTheme.titlename;
            ...
            this.messageElement.find('.chat-view-message-table').html([
                ...
                '<tr style="' + $.STYLE_NBODY + '"><td colspan="', ($.browser.mobile ? 1 : 2), '" style="' + $.STYLE_BODY + 'padding:0 0 15px 0;color:'+timestamp+';vertical-align:top;">', announcement, '</td></tr>', (disable_message ?
                    '' : [$.FORM.createInput(formOptions),
                        '<tr style="' + $.STYLE_NBODY + '">',
                        //移动端不显示表单文本
        ...
        _getMessageHtml: function(type, data) {
            ...
            return type === 'right' ? [ //发送的消息
                  '<table style="', $.STYLE_NBODY, 'float:right;_float:none;width:100%;margin:4px 0 0 0;" class="view-history-right" cellpadding="0" cellspacing="0" border="0" class="table">',
                    '<tbody style="', $.STYLE_NBODY, 'text-align:center;">',
                    '<tr><td style="', $.STYLE_BODY, 'text-align:center;">', (data.showTime ? '' : ['<span class="view-history-time" style="', $.STYLE_BODY, ';color:'+timestamp+';line-height:26px;">',
                    ...
                    '</tbody>',
                    '</table>',
                  '<table style="', $.STYLE_NBODY, 'float:right;_float:none;margin-top:10px;" class="view-history-right" cellpadding="0" cellspacing="0" border="0" class="table">',
                    '<tbody style="', $.STYLE_NBODY, 'text-align:right;">',
                    '<tr>',
                    '<td class="view-history-send-tbody" style="', $.STYLE_BODY, '">',
                    (
                        //发送文件时
                        4 == data.type ? ['<div class="view-history-body" type="', data.type, '" style="', $.STYLE_NBODY, 'word-break:break-all;word-wrap:break-word;padding:8px;border-top-left-radius:10px;border-top-right-radius:10px;border-bottom-left-radius:10px;background:'+bubble+';border:1px solid #a1cce8;border-color:'+bubble+'">',
                        ...
                        //消息或图片
                        //2016.04.06
                        ['<div class="view-history-body" type="', data.type, '" style="', $.STYLE_BODY, 'line-height:160%;', (data.type == 2 ? 'color:'+bubble_text+';text-align:center;display:table-cell;*display:inline-block;vertical-align:middle;width:75px;height:75px;*font-size:0px;*line-heihgt:0px;*font-family:Arial;padding:2px;background:none;border-top-left-radius:10px;border-top-right-radius:10px;border-bottom-left-radius:10px;' : 'display:block;'), 'word-break:break-all;word-wrap:break-word;padding:6px;color:'+bubble_text+';background:'+bubble+';border:1px solid #a1cce8;border-color:'+bubble+';border-top-left-radius:10px;border-top-right-radius:10px;border-bottom-left-radius:10px;margin-left:50px;">', (/^(1|9)$/i.test(data.type) ? data.msg : /^2$/i.test(data.type) && data.oldfile ? data.oldfile : ''),
                            '</div>',
                         '<div class="view-history-pic-status" style="position: relative; top: -20px; margin:0px; left:-2px; padding:0px;font-size:12px; text-align:center; display:none"></div>'
                        ].join('')
                    ),
                    //==相关状态==
                    ...
                    '<img class="view-history-status-loading" src="', $.sourceURI + 'images/m-loading.gif','" style="', $.STYLE_NBODY, 'float:left;display:block;width:22px;height:22px;position:absolute;top:-50px;left:30px"></img>',
                    '<div class="view-history-status-link" style="', $.STYLE_BODY, 'float:left;margin-top:10px;"></div>',
                    '</div>',
                    '</span>',
                    '</td>',
                    //==尖角==
                    (data.type == 2 ? ['<td style="', $.STYLE_NBODY, 'vertical-align:top;width:49px;_width:49px;height:auto;min-height:49px;position:relative;">',
                    '<div valign="bottom" class="view-chat-angle" style="display:none;width:19px;position:absolute;bottom:1px;left:-1px;">',
                      '<svg width="19px"  height="23px" id="svg" >',
                    '<path d="M0,0 L0,23 L19,23 C16,21 2,19 1,0" style="fill:'+bubble+';" />' ,
                    '</svg>',
                    '</div>',
                    //访客头像 10.27 在背景图中的位置变更
                    '<div style="', $.STYLE_NBODY, 'position:absolute;left:3px;bottom:3px;text-align:center;width:43px;height:43px;border:3px solid rgba(255,255,255,0.2);border-radius:50%;">',
                    '<div style="', $.STYLE_NBODY, 'text-align:center;width:41px;height:41px;border-radius:50%;border:1px solid rgba(255,255,255,0.2);background:url(', $.imageicon,') no-repeat -299px -170px;overflow:hidden;">',
                    '</div>',
                    '</td>'].join("") :
                    ['<td style="', $.STYLE_NBODY, 'vertical-align:top;width:49px;_width:49px;height:auto;min-height:49px;position:relative;">',
                     '<div valign="bottom" class="view-chat-angle" style="width:19px;position:absolute;bottom:1px;left:-1px;">',
                      '<svg width="19px"  height="23px" id="svg" >',
                    '<path d="M0,0 L0,23 L19,23 C16,21 2,19 1,0" style="fill:'+bubble+';" />' ,
                    '</svg>',
                    '</div>',
                ...
                /left|bottom/gi.test(type) ? [ //接收的消息
                    //2016.04.13
                    '<table style="', $.STYLE_NBODY, 'width:100%;margin:4px 0 0 0;" class="view-history-left" cellpadding="0" cellspacing="0" border="0" class="table">',
                    '<tbody style="', $.STYLE_NBODY, 'text-align:center;">',
                    '<tr><td style="', $.STYLE_BODY, 'text-align:center;">', (type == 'bottom' || data.showTime ? '' : ['<span class="view-history-time" style="', $.STYLE_BODY, 'color:'+timestamp+';line-height:26px;">',
                    ...
                    '</tbody>',
                    '</table>',
                    '<table style="', $.STYLE_NBODY, 'float:none;margin:10px 0 0 0" class="view-history-left" cellpadding="0" cellspacing="0" border="0" class="table">',
                    '<tbody style="', $.STYLE_NBODY, '">',
                    '<tr>',
                    //头像 2015.10.27 默认头像位置变更 将头像和边角放在一个td中更改
                    '<td style="', $.STYLE_NBODY, 'vertical-align:top;width:49px;_width:49px;height:auto;min-height:49px;position:relative;">',
                    '<div class="view-history-icon-div" style="', $.STYLE_NBODY, 'text-align:center;position:absolute;bottom:3px;right:3px;width:43px;height:43px;border-radius:50%;border:3px solid rgba(159,249,255,0.2);">', (data.logo ? ['<img data-single="1" onerror="nTalk.loadImageAbnormal(this, event)" class="view-history-receive-icon" userid="', data.userid, '" src="', data.logo, '" style="', $.STYLE_NBODY, 'width:41px; height:41px;border-radius:50%;border:1px solid rgba(159,249,255,0.2);" />'
                        ].join('') : ['<div style="', $.STYLE_NBODY, 'width:41px; height:41px;border-radius:50%;border:1px solid rgba(159,249,255,0.2);background:url(', $.imageicon, ') no-repeat -347px -170px;overflow:hidden;"></div>'].join('')),
                    '</div>',
                    //客服名称
                   //'<td colspan="2"><div style="color:'+timestamp+'; font-size:12px; padding-left:5px; height:20px; line-height:20px; margin-top:-3px">', (data.name || this.mode.dest.name), '</div></td>',

                    //==尖角==
                    ['<div valign="bottom" class="view-chat-angle" style="width:19px;',data.type==2 ? 'display:none;' : '','position:absolute;bottom:1px;right:-1px;">',
                      '<svg width="19px"  height="23px" id="svg" >',
                    '<path  d="M19,0 L19,23 L0,23 C5,21 17,15 18,0" style="fill:#ffffff;" />' ,
                    '</svg>',
                    '</div>'].join(""),
                    '</td>',
                    ...
                    (
                        //收到文件时
                        4 == data.type ? ['<div class="view-history-body" style="', $.STYLE_BODY, 'word-break:break-all;word-wrap:break-word;border-top-right-radius:10px;border-top-left-radius:10px;border-bottom-right-radius:10px;padding:8px 0;background:white;border:1px solid #ffffff;">',
                           //上面的整个div
                            '<div style="', $.STYLE_NBODY, 'margin:0 8px;height:auto;clear:both;">',
                            '<div style="', $.STYLE_NBODY, 'float:left;width:42px;height:42px;background-color:#1294e2;text-align:center;border-radius: 10px;-webkit-border-radius: 10px;-moz-border-radius: 10px;-o-border-radius: 10px; -ms-border-radius: 10px;">',
                             //文件的后缀名称
                ...
                type === 'first' ? [ //系统消息:接通客服
                    '<div class="view-history-system" style="', $.STYLE_BODY, 'height:20px;line-height:180%;marign:0 auto;text-align:center;word-break:break-all;word-wrap:break-word;display:none;">',
                    data.msg,
                    '</div>',
                    '<br style="', $.STYLE_NBODY, 'clear:both;" />'
                ].join('') :
                type === 'goods' ? [ //商品信息
                //2016.04.08
                    '<table style="', $.STYLE_NBODY, 'width:100%;border-radius:10px;margin:10px 0;border:1px solid #ccc;" class="view-history-goods" cellpadding="0" cellspacing="0" border="0" class="table">',
                    '<tbody style="', $.STYLE_NBODY, 'text-align:center;">',
                    '<tr>',
        ...
        _getViewHtml: function(type) {
            //2016.04.07 留言区的
            //var background_whole='#f3f3f7';

            $.face_image=$.sourceURI + 'images/wapTheme3/xiaolian.png';
            $.face_image1= $.sourceURI + 'images/wapTheme3/xiaolian1.png';
            $.button_action_image= $.sourceURI + 'images/wapTheme3/tianjia.png';
            $.button_action_image1= $.sourceURI + 'images/wapTheme3/tianjia1.png';
            $.evaluate_image= $.sourceURI + 'images/wapTheme3/pingjia.png';
            $.evaluate_image1= $.sourceURI + 'images/wapTheme3/pingjia1.png';
            $.pic_image= $.sourceURI + 'images/wapTheme3/image.png';
            $.pic_image1= $.sourceURI + 'images/wapTheme3/image1.png';
            $.audio_image=$.sourceURI + 'images/wapTheme3/yuyin.png';
            $.audio_image1=$.sourceURI + 'images/wapTheme3/yuyin1.png';
            $.jianpan_image=$.sourceURI + 'images/wapTheme3/jianpan.png';
            $.jianpan_image1=$.sourceURI + 'images/wapTheme3/jianpan1.png';
            $.beijing_image=$.sourceURI + 'images/wapTheme3/beijing.jpg';
            ...
            return type == 'load' ? [
                ...
                type === 'window' ? [
                    //分配客服时状态消息将top值全部改为44px
                    '<div class="chat-view-window-status-info" style="', $.STYLE_BODY, 'margin-top:44px;overflow:hidden;background:#f9efda;width:100%;line-height:55px;height:55px;position:fixed;top:0;display:none;z-index:300">',
                    '<div class="chat-view-system-message" style="', $.STYLE_BODY, 'margin:0px 0 0 0px;text-align:center;line-height:55px;font-size:16px;color:#85837A"></div>',
                    ...
                    '</div>',
                    //2016.04.15 更改margin 增加padding 值
                    '<div class="chat-view-window-history" style="', $.STYLE_BODY, 'width:100%;padding:0px 0 ',($.browser.iPhone ? '132px' : '52px'),' 0">',
                    //2016更改将背景设置为透明的 更改margin 值
                    '<ul style="', $.STYLE_BODY, 'list-style:none;margin:0px 10px 0 10px;background:transparent">',
                ...
                type == 'bottom' ? [
                    //音频区
                    (
                         $.Audio && $.Audio.support() ? '<div class="chat-view-window-audio" style="' + $.STYLE_NBODY + 'position:relative;display:none;-webkit-tap-highlight-color:rgba(0,0,0,0);">' + '<div class="chat-view-button-text" style="' + $.STYLE_NBODY + 'width:32px;height:32px;position:absolute;left:5px;top:5px;cursor:pointer;background:url('+$.jianpan_image+') no-repeat;background-size:cover;">' +
                    ...
                    '<div class="chat-view-window-editor" style="', $.STYLE_NBODY, 'position:relative;display:block;">', (
                        $.Audio && $.Audio.support() ? '<div class="chat-view-button-audio" style="' + $.STYLE_NBODY + 'width:32px;height:32px;position:absolute;top:5px;left:5px;cursor:pointer;background-image:url('+$.audio_image+');background-repeat:no-repeat;background-size:cover;-webkit-tap-highlight-color:rgba(0,0,0,0);">' +
                    ...
                    '<textarea placeholder="', $.lang.default_textarea_text, '" style="', $.STYLE_BODY, 'background:#fff;height:17px;line-height:17px;width:100%;resize:none;outline:none;padding:10px 0 10px 5px;border:1px solid #d4d4d4;border-radius:20px"></textarea>',
                    '</div>',
                    '</div>',
                   '<div class="chat-view-button-face" style="' + $.STYLE_BODY + 'background:#F9F9F9;width:32px;height:auto;position:absolute;right:55px;top:8px;cursor:pointer;-webkit-tap-highlight-color:rgba(0,0,0,0);">',
                    '<div style="text-align:center;width:32px;height:32px;background-image:url('+$.face_image+');background-repeat:no-repeat;background-size:cover;"></div>',
                    '</div>',

                     //2016.02.19  人工客服的图片
                   '<div class="chat-view-switch-manual" title="', $.lang.button_switch_manual, '" style="' + $.STYLE_BODY + 'background:#F9F9F9;width:32px;height:32px;margin:8px 4px;position:absolute;right:10px;top:0px;text-align:center;cursor:pointer">',
                    '<svg class="chat-view-switch-manual-svg" width="32" height="32" xmlns="http://www.w3.org/2000/svg" >',
                        '<circle id="myCircle" cx="16" cy="16" r="15" stroke="#808080" fill="white" stroke-width="1" />',
                        '<path d="M23,12 C23,5 9,5 9,12"  stroke="#808080" fill="white"/>',

                        '<circle id="myCircle" cx="16" cy="14" r="5" stroke="#808080" fill="white" stroke-width="1" />',
                        '<path d="M9,12 C6,12 6,17 9,17" fill="#808080" stroke="#808080"/>',
                        '<path d="M23,12 C26,12 26,17 23,17" fill="#808080" stroke="#808080"/>',
                        '<line x1="20" y1="19" x2="18" y2="18" stroke="#808080" />',
                        '<path d="M14,19 C10,16 6,26 8,25" stroke="#808080" fill="white"/>',
                        '<line x1="25" y1="21" x2="25" y2="24" stroke="#808080"/>',
                        '<line x1="25" y1="24" x2="17" y2="24" stroke="#808080"/>',
                        '<line x1="20" y1="22" x2="17" y2="24" stroke="#808080"/>',
                        '<line x1="17" y1="24" x2="20" y2="26" stroke="#808080"/>',
                   ...
                   //2016.04.11
                   '<div style="width:32px;height:32px;background-image:url('+$.button_action_image+');background-repeat:no-repeat;background-size:cover;">',
                   '</div>',
                   /* '<svg width="32" height="32">',
                        '<circle cx="16" cy="16" r="15" stroke-width="1" stroke="#808080" fill="#F9F9F9"></circle>',
                        '<rect x="15" y="6" width="2" height="20" stroke-width="1" stroke="#808080" fill="#808080"></rect>',
                        '<rect x="6" y="15" width="20" height="2" stroke-width="1" stroke="#808080" fill="#808080"></rect>',
                    '</svg>',*/
                    '</div>',
                    ...
                    '<div style="', $.STYLE_BODY, 'text-align:center;">', $.lang.button_evaluation, '</div>',
                    '</div>',*/
                    //上传图片、文件
                    '<div class="chat-view-action-button chat-view-image" style="', $.STYLE_NBODY, 'margin:31px 10px 27px 57px;float:left;width:42px;height:auto;position:relative;-webkit-tap-highlight-color:rgba(0,0,0,0);">',
                    '<div class="chat-view-button-image" style="', $.STYLE_BODY, 'text-align:center;width:41px;height:41px;background:url(',  $.pic_image, ') ;background-size:cover; "></div>',
                    '<div style="', $.STYLE_BODY, 'position:relative;bottom:0;text-align:center;margin-top:11px;overflow-x:hidden">', $.lang.button_image, '</div>',
                    '</div>',
                     //评价按钮 2016.04.11更改
                    '<div class="chat-view-action-button chat-view-evaluate" style="', $.STYLE_NBODY, 'margin:31px 5px 27px 57px;float:left;width:42px;position:relative;-webkit-tap-highlight-color:rgba(0,0,0,0);">',
                    '<div class="chat-view-button-image" style="', $.STYLE_BODY, 'text-align:center;width:41px;height:41px;background:url(', $.evaluate_image, ') ;background-size:cover;"></div>',
                    '<div style="', $.STYLE_BODY, 'text-align:center;margin-top:11px;overflow-x:hidden">', $.lang.button_evaluation, '</div>',
                    '</div>',
                    /*
        ...
        _bind: function() {
            ...
            this.faceButton = this.bottomElement.find('.chat-view-button-face').bind('touchstart',function(event) {
                    $(this).find('div').css({
                    'background-image':'url('+$.face_image1+')'
                  });
                }).bind('touchend',function(event){
                  $(this).find('div').css({
                    'background-image':'url('+$.face_image+')'
                  });
                }).tap(function(event) {
                //表情统计点
            ...
            this.actionButton = this.bottomElement.find('.chat-view-button-action').bind('touchstart',function(event) {
                   $(this).find('div').css({
                    'background-image':'url('+$.button_action_image1+')'

                  });
                }).bind('touchend',function(event){
                    $(this).find('div').css({
                    'background-image':'url('+$.button_action_image+')'
            ...
            this.bottomElement.find('.chat-view-action-button').bind('touchstart',function(event) {
                if ($(this).attr('talk_disable') == 'disable') {
                 ...
                 //2016.04.11新增
                    if($(this).indexOfClass('chat-view-image')){
                       $(this).find('.chat-view-button-image').css({
                           'background':'url('+$.pic_image1+')',
                           'background-size':'cover'
                        });
                    }
                    else if($(this).indexOfClass('chat-view-evaluate')){
                        $(this).find('.chat-view-button-image').css({
                           'background':'url('+ $.evaluate_image1+')',
                           'background-size':'cover'
                        });
                    }
                /*  else{
                ...
                if ($(this).attr('talk_disable') == 'disable') {
                 ...
                 //2016.04.11新增
                    if($(this).indexOfClass('chat-view-image')){
                        $(this).find('.chat-view-button-image').css({
                           'background':'url('+$.pic_image+')',
                           'background-size':'cover'
                        });
                    }
                    else if($(this).indexOfClass('chat-view-evaluate')){
                        $(this).find('.chat-view-button-image').css({
                           'background':'url('+ $.evaluate_image+')',
                           'background-size':'cover'
                        });
                    }
                  /*  else{
        ...
        _initAudio: function() {
            ...
            this.bottomElement.find('.chat-view-button-audio').bind('touchstart',function(){
              //2016.04.13更改样式
               $(this).css({
               'background-image':'url('+$.audio_image1+')'
                 });
               }).bind('touchend',function(){
                   $(this).css({
                  'background-image':'url('+$.audio_image+')'
                 });
            ...
            this.bottomElement.find('.chat-view-button-text').bind('touchstart',function(){
               //2016.04.13
                $(this).css({
               'background-image':'url('+$.jianpan_image1+')'
                 });
               }).bind('touchend',function(){
                   $(this).css({
                  'background-image':'url('+$.jianpan_image+')'
                 });
            }).tap(function(e) {
            ...
            var voiceHtml = ['<div id="voiceContainer" style="position:relative;top:42px;left:45px;width:60px;height:110px;background: url(',$.imageicon,') no-repeat -168px -151px; z-index:100">',
                             ...
                             '</div>',
                             '<div style="position: relative;width: 180px; height:30px; line-height: 30px;z-index:100; color: #FFF; top: 46px; left: 10px; text-align:center;font-weight:bold">',$.lang.chat_button_audio_fingerup,'</div>'].join('');
            ...
            var fingerUpHtml = ['<div id="voice_cancel" style="position:relative;top: 42px;left:65px;width:60px;height:110px;background:url(',$.imageicon,') no-repeat -100px -151px; z-index:100">',
                                '</div>',
                                '<div style="position:relative;width:180px;height:30px;line-height:30px;z-index:100; color:white; top:46px; left:10px; text-align:center;font-weight:bold; background-color:#A84B4B; border-radius:5px">',$.lang.chat_button_audio_freefinger,'</div>'].join('');
            ...
            var shortTimeHtml = ['<div style="position:relative;top: 42px;left:55px;width:90px;height:110px;background:url(',$.imageicon,') no-repeat -0px -151px; z-index:100">',
                                '</div>',
                                '<div style="position:relative;width:180px;height:30px;line-height:30px;z-index:100; color:white; top:46px; left:10px; text-align:center;font-weight:bold;">',$.lang.chat_button_audio_shorttime,'</div>'].join('');
            ...
            this.bottomElement.find('.chat-view-window-audio input').gesture('hold', function() {
                ...
                if(self.audioDisable()){
                	Gesture.toast = new $.Toast('<div style="position: relative;width: 200px; height:30px; line-height: 30px;z-index:100; color: #FFF; top: 30px; left: 25px; text-align:center;font-weight:bold">' + $.lang.chat_button_audio_error + '</div>', {width: 250, height:90});
                ...
                Gesture.toast = new $.Toast(voiceHtml, {width: 200, height: 200});
                ...
                holdCancelToast = new $.Toast('<div style="position: relative;width: 200px; height:30px; line-height: 30px;z-index:100; color: #FFF; top: 30px; left: 25px; text-align:center;font-weight:bold">' + $.lang.chat_audio_orientation_stop + '</div>', {width: 250, height:90});
                removeGestureTimeout = setTimeout(function(){
        ...
        audioProgress: function(msgid, progress) {
            ...
            //设置背景为预置图片，设置提示语为正在上传，隐藏重新发送按钮，显示loading图标
            liEl.find('.view-history-status').css({'left': '-60px', 'top': '23px'}).display(1);
            liEl.find('.view-history-status-icon').display(0);
            liEl.find('.view-history-status-loading').display(1);
        },
	 ...
	 * @param  {boolean} hidden    隐藏|显示控制区域
        ...
        hideAudioButton: function() {
            ...
            $('.chat-view-textarea').css({'margin-left':'5px'});
        },
        ...
        switchToolbar: function(manual, source) {
            ...
            if (manual) {
                this.bottomElement.find('.chat-view-textarea').css({
                    'padding-right': '0px',
                    'margin-left': ($.Audio.support() && this.mode.config.enable_audio == 1) ? '45px' : '5px',
        ...
        setDescIcon: function(parentElement, userid) {
            ...
            if (!dest || this.mode.isVisitor(userid) || !dest.logo) {
               ...
               // parentElement.find('.view-history-icon-div .view-history-receive-icon').remove();
                //parentElement.find('.view-history-icon-div').html(['<div style="', $.STYLE_NBODY, 'width:41px; height:41px;border-radius:50%;border:1px solid rgba(159,249,255,0.2);background:url(', $.imageicon, ') no-repeat -347px -170px;overflow:hidden;"></div>'].join(''));
            } else {
                //2016.04.18
                parentElement.find('.view-history-icon-div div').remove();
                ...
                $.require(dest.logo + '#image', function(image) {
                    if (image.error !== true) {
                        attr = $.zoom(image, 41, 41);
                        icon = parentElement.find('.view-history-icon-div .view-history-receive-icon');
                        ...
                        if (!icon.length) {
                            icon = $({
                                ...
                                //2016.04.15增加边框
                                style: $.STYLE_NBODY+'border-radius:50%;border:1px solid rgba(159,249,255,0.2)'
                            }).appendTo(parentElement.find('.view-history-icon-div'));
                        }
                        icon.attr({
                            width: attr.width || 41,
                            height: attr.height || 41,
                            src: dest.logo
                        }).css({
                            width: (attr.width || 41) + 'px',
                            height: (attr.height || 41) + 'px'
        ...
        changeQueueStyle: function() {
            ...
            $('.chat-view-queue-num').css({'color': '#E97D3A', 'font-size': '12px'});
...
/*            var colorExp = /^#[0-9a-f]{6}$/i;
         ...
         * @return {void}
         */
        _callEndSession: function(validation, isHideWindow){
            var self = this,
                chat = this._manageMode.get(),
        ...
        _create: function() {
            ...
            var titlename=newWapTheme.titlename;
            var header_title_height='44';
           //2016.04.12 匹配图片还是颜色值
            var title=newWapTheme.title;
            var nowData=new Date().getTime();
            //var title='http://192.168.30.177/22.jpg';
            var title_color_RegExp=/^#[0-9a-f]{6}$/i;
            var title_whole_exp=title_color_RegExp.test(title)?'background-color:'+title+'':'background-image:url('+title+'?'+nowData+');background-repeat:no-repeat;background-size:cover';


            var self = this,
                html = [
                    '<div class="chat-view-window-header-message-title" style="', $.STYLE_BODY, 'display:none;color:'+titlename+';margin:0 0px;font-size:16px;font-weight:bold;text-align:center;line-height:'+header_title_height+'px;height:'+header_title_height+'px;overflow:hidden;'+title_whole_exp+'"></div>',
                    '<div class="chat-view-window-header-title" style="', $.STYLE_BODY, 'color:'+titlename+';margin:0 85px;font-size:16px;font-weight:bold;text-align:center;line-height:'+header_title_height+'px;height:'+header_title_height+'px;overflow:hidden;z-index:50"></div>',
            ...
            this.header = $({
                ...
                //2016.04.08更改高度
                //style: $.STYLE_NBODY +title_whole_exp+';width:99.9%;height:'+header_title_height+'px;position:fixed;left:0;top:0;z-index:999;float:left;'
                 style: $.STYLE_NBODY +'width:99.9%;height:'+header_title_height+'px;position:absolute;left:0;top:0;z-index:999;float:left;'
            }).appendTo(true).html(html).fixed({
                width: '100%',
                left: '0px',
                top: '0px'
            });
            ...
            var backButtonHtml = [
                "<div class='chat-view-window-header-back' style='position: absolute; width:30px; height:30px; z-index:50; left: 12px; top: 9px'>",
                //2016.04.7更改成为符号

                 '<div style="line-height:20px;height:20px;width:20px;font-size:20px;padding:5px;font-family:iconfont;color:'+return_color+'">'+return_style+'</div></div>'].join("");
               /* '<svg width="32" height="32">',
            ...
            var closeButtonHtml = [
                "<div class='chat-view-window-header-ev-close' style='position: absolute; width:30px; height:30px; z-index:50;right: 12px; top: 9px;display:none;'>",
                //2016.04.7
              '<div style="line-height:20px;height:20px;width:20px;opacity:1;font-size:20px;padding:5px;font-family:iconfont;color:'+close_color+'">'+close_style+'</div></div>'].join("");
                /*'<svg width="32" height="32">',
                    '<circle cx="16" cy="16" r="15" fill="#FFF" style="fill-opacity:0.7"></circle>',
                    '<circle cx="16" cy="16" r="8" stroke-width="1.5" stroke="#E56060" fill="#FFF" style="fill-opacity:0.7"></circle>',
                    '<line x1="12.5" y1="12.5" x2="19.5" y2="19.5" style="stroke:#E56060;stroke-width:1.5"/>',
                    '<line x1="12.5" y1="19.5" x2="19.5" y2="12.5" style="stroke:#E56060;stroke-width:1.5"/>',
                '</svg></div>'].join(""); */
            //2016.04.15重写title栏目 让其透明度为0.5
           var headerSecond=[
            '<div class="chat-view-window-header" style="'+$.STYLE_NBODY +title_whole_exp+';opacity:0.5;width:99.9%;height:'+header_title_height+'px;position:fixed;left:0;top:0;z-index:10;">',
              '</div',

            ].join("");
            //2016.04.15
            this.header.append(backButtonHtml).append(closeButtonHtml).append(headerSecond);
            ...
            this.header.find('.chat-view-window-header-back').tap(function(event) {
                ...
                if($.params.iframechat == "1"){
                    self._callEndSession(false, true);
                }else{
            ...
            this.header.find('.chat-view-window-header-ev-close').tap(function(event) {
                $.Event.fixEvent(event).stopPropagation();
                self._callEndSession(true, true);
            });
