;(function($, undefined){
	...
	$.chatView.prototype = {
       ...
       /*
          2016.03.02 添加需求，特制zuk


          */
          _zuk_special:function(){
          	var zuk_chat_head_body = $('.chat-header-body');
          	var zuk_chat_view_window_bottom=this.contains.find('.chat-view-window-bottom');
            var zuk_chat_view_end_session=this.contains.find('.chat-view-end-session');
            var zuk_chat_view_submit=this.contains.find('.chat-view-submit');
          	var zuk_chat_view_options=this.contains.find('.chat-view-options');
          	var zuk_body_chat_containter=this.contains.find('.body-chat-containter');
          	var zuk_chat_view_window_editor=this.contains.find('.chat-view-window-editor').find('textarea');
          	//var zuk_view_history_more=this.contains.find('.view-history-more');
            var zuk_ntalk_button_close=$('.ntalk-button-close');                
          	var zuk_ntalk_button_maxresize=$('.ntalk-button-maxresize');
            var zuk_ntalk_button_min=$('.ntalk-button-min');
            var zuk_chat_view_lbar=$('.chat-view-lbar');
            var zuk_chat_view_options_menu=$('.chat-view-options-menu');

          	zuk_chat_view_window_bottom.css('background','#ffffff');
          		
          		zuk_chat_view_end_session.css({
          		margin:'6px 0',
          	...
          	zuk_chat_view_submit.css({
                  margin:'6px 0 0 10px',
                  
                  'background-color':'#10bad0',
                  border:'solid 0px #10bad0',
                  'font-size':'14px',
                  height:'28px',
                 'line-height': '28px',
         ...
         zuk_chat_view_options.css({
          	...
          	zuk_chat_view_window_editor.css('box-shadow','white 0px 0px 0px inset');
            zuk_ntalk_button_close.css({
          	...
          	zuk_ntalk_button_min.css({
               margin:'24px 0 0 0',
               width:'16px',
			   display: 'none'
          	});
          //2016.03.04
            zuk_ntalk_button_maxresize.css({
            	display:'none',
            	'height':'0',
            	'width':'0'
            });
           
            //zuk_view_history_more.display();

            //隐藏更多按钮
           // this.chatElement.find('.chat-view-exp').display();
            //发送按钮悬浮在上面
            zuk_chat_view_submit.hover(function(event){
				$.Event.fixEvent(event).stopPropagation();
				$(this).css({
					'background-color': '#6cbef8'
				});
				zuk_chat_view_lbar.css('display','none');
			}, function(event){
				$.Event.fixEvent(event).stopPropagation();
				$(this).css({
					'background-color': '#10bad0'
			...
			if(zuk_chat_view_options_menu.css('display')=='none'){
	             
					zuk_chat_view_lbar.css('display','block');
				}
			else{
			...
			//多选项悬浮在上面
			 zuk_chat_view_options.hover(function(event){
				$.Event.fixEvent(event).stopPropagation();
				$(this).css({
					'background-color': '#6cbef8'
				});
       ...
       /**
		...
		_getMessageHtml: function(type, data){
			...
			return type === 'right' ?
					...
					'<table style="',$.STYLE_NBODY,'float:right;_float:none;border-collapse:separate;" class="view-history-right" cellpadding="0" cellspacing="0" border="0" class="table">',
						...
						'<tr style="',$.STYLE_NBODY,'">',
							...
							//2016.03.02更改背景颜色和字体粗细
								'<td class="view-history-content" style="',$.STYLE_BODY,'padding:8px;background:#dbeffe;font-border:0px solid #d5d5d5;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;">',
								...
								'<td style="',$.STYLE_NBODY,'width:20px;vertical-align:middle;overflow:visible;">',
									//尖角添加className
									'<div class="view-history-angle" style="',$.STYLE_NBODY,'position:relative;left:-1px;z-index:1;width:20px;height:18px;top:10px;background:url(',$.imageicon,') no-repeat -1px -61px;"></div>',//
								'</td>',
							'</tr>',
				...
				//2016.03.08 新增 padding 值
					'<table style="',$.STYLE_NBODY,'float:left;float:none;table-layout:auto;border-collapse:separate;padding:0 0 0 4px;" class="view-history-left" cellpadding="0" cellspacing="0" border="0" class="table">',
						'<tbody style="',$.STYLE_NBODY,'">',
						 //2016.03.08更改时间tr和内容的位置
							...
							'<tr style="',$.STYLE_NBODY,'">',
                               '<td style="',$.STYLE_NBODY,'width:20px;vertical-align:middle;overflow:visible;">',
									//尖角添加className 增加样式
									'<div class="view-history-angle" style="',$.STYLE_NBODY,'position:relative;right:-1px;top:10px;z-index:1;width:20px;height:18px;background:url(',$.imageicon,') no-repeat -20px -62px;"></div>',
								'</td>',
								//2016.03.02背景颜色更改
								'<td class="view-history-content" style="',$.STYLE_BODY,'padding:8px;background:#e5e5e5;border:0px solid #d5d5d5;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px">',
				...
				[
					...
					'<div class="chat-view-window-history" style="',$.STYLE_BODY,'width:100%;height:270px;height:267px\\0;_height:269px;background-repeat:no-repeat;background-position:center bottom; padding-top:1px solid #fff\\0;position:relative;overflow-x:hidden;overflow-y:scroll;">',
						'<ul style="',$.STYLE_NBODY,'list-style:none;margin:10px 0px 10px 0px;">',
							    //2016.03.03显示欢迎语句
							    '<span style="',$.STYLE_NBODY,'height:14px;font-size:12px;color:#b3b3b3;line-height:14px;padding-left:18px;">',
						           
                                 
						       '\u004d\u006f\u0074\u006f\u5b98\u7f51\u5ba2\u670d\u4e13\u5458\u6b63\u5728\u4e3a\u60a8\u670d\u52a1\u002e\u002e\u002e</span>',
						'</ul>',
					'</div>',
					//2016.03.03 更改border边框的颜色
					'<div class="chat-view-window-toolbar" style="',$.STYLE_BODY,'height:28px;width:100%;border-top:1px solid #e4e4e4;background:#f9f9f9;">',
						//分配客服时状态消息
						...
						//2016.03.07　将文件进行隐藏
						'<div class="chat-view-button chat-view-file" title=',$.lang.button_file,' style="',$.STYLE_BODY,'color:#525252;float:left;margin:4px 0 4px 10px;border:0px solid #ccc;height:20px;display:inline-block;cursor:pointer;width:20px;background:url(',$.imageicon,') no-repeat -140px 0;display:none;"></div>',
					...
					'<div class="chat-view-window-bottom" style="',$.STYLE_BODY,'height:40px;width:100%;background:#f9f9f9;border-radius:0px 0px 0px 5px;-moz-border-radius:0px 0px 0px 5px;-webkit-border-radius:0px 0px 0px 5px">',
						'<div class="chat-view-options" style="',$.STYLE_BODY,'margin:6px 10px 6px 0;float:right;border:1px solid #ccc;width:14px;height:26px;line-height:25px;text-align:center;cursor:pointer;">',
							...
							'<div class="chat-view-hidden-area" style="',$.STYLE_NBODY,'width:1px;height:1px;position:relative;overflow:visible;">',
								...
								'<div class="chat-view-span chat-view-options-menu" style="',$.STYLE_BODY,'display:none;background:#fff;position:absolute;left:-166px;top:-82px;border:1px solid #f4f4f4;border-radius:3px;width:188px;*width:104px;_width:104px;height:auto;z-index:1000002;cursor:cursor;">',
									//发送消息方式 
						...
						'</div>',
						//2016.03.06新增一个div 
						//'<div class="chat-view-lbar" style="position:absolute;right:34px;width:1px;height:14px;background:#ffffff;margin:14px 0"></div>',
		...
		_hiddenFloatMenu: function(){
			...
			this.chatElement.find('.chat-view-lbar').css('display','block');
		...
		_initFaceGroup: function(){
			...
			$.each(this.mode.config.faces, function(i, cFace){
				...
				if( !self.chatElement.find('.' + groupClass).length ){
					//2016.03.08 修改margin 值
					self.chatElement.find('.chat-view-window-face').insert('<div class="' + groupClass + ' chat-view-face-group" style="' + $.STYLE_NBODY + (i == 0 ? '' : 'display:none;') + 'overflow-x:hidden;overflow-y:auto;margin:10px 0px 4px 8px;clear:left;height:165px;"></div>', 'afterbegin');
				}
				$.each(cFace.pics, function(faceIndex, jsonFace){
					var j	= faceIndex + 1;
					var alt	= i == 0 ? ' title="' + jsonFace.sourceurl + '"' : ' title="" sourceurl="' + jsonFace.sourceurl + '"';
					//cstyle	= style + 'border:1px solid #e2e6e7;border-left:1px solid #e2e6e7;border-bottom:1px solid #e2e6e7;background:#ffffff;' + (j<=6 ? 'border-top:1px solid #e2e6e7;' : '') + (j%6==0 ? 'border-right:1px solid #ffffff;' : '');
					//2016.03.08更改颜色
					if(i==0){
					cstyle	= style + 'border:1px solid #ffffff;background:#ffffff;' + (j<=18 ? 'border-bottom:1px solid #e2e6e7;' : '') + (j%6==0 ? '' : 'border-right:1px solid #e2e6e7;');
					
					}else{
						cstyle	= style + 'border:1px solid #ffffff;background:#ffffff;' + (j<=54 ? 'border-bottom:1px solid #e2e6e7;' : '') + (j%6==0 ? '' : 'border-right:1px solid #e2e6e7;');

					}

					//2016.03.08修改border 颜色值
					self.chatElement.find('.' + groupClass).append('<img src="' + jsonFace.url + '" ' + alt + ' border="0" style="' + cstyle + '" img_index="'+ j+'" tag_index="' +i+ '" />');

				});
				//组标签
				if( i == 0 ){
					//2016.03.08 增加border 颜色
			...
			this.chatElement.find('.chat-view-face-group').hover(function(event){
				...
				var border_bttom_a;
				var border_right_b;
				if($(srcElement).attr('tag_index')==0){
					if($(srcElement).attr('img_index')<=18){
						border_bttom_a='1px solid #e2e6e7';
					}
					else{
						border_bttom_a='';
					}
				}else{
					 if($(srcElement).attr('img_index')<=54){
						border_bttom_a='1px solid #e2e6e7';
					}
					else{
						border_bttom_a='';
				...
				if($(srcElement).attr('img_index')%6==0){
					border_right_b='';
				}
				else{
					border_right_b='1px solid #e2e6e7';
				}
               $(srcElement).css({
					//"background-color": '#F6FBFE',
					//2016.03.08 增加边框
					border:'1px solid #ffffff',
					'border-bottom':border_bttom_a,
					'border-right':border_right_b
                });
	...
	$.chatManageView.prototype = {
		...
		_create: function(){
			...
			this._objView.buttonMin.hover(function(){
				//更改位置
				$(this).css('background-position', '-4px -20px');
			}, function(){
				//2016.03.07更改位置
				...
				margin: '20px 5px 0 0',
				//更改位置
				background: 'url(' + $.imageicon + ') no-repeat -4px 0'
			}).attr('title', $.lang.chat_button_min);
		    //2016.03.02变化背景颜色 和top值将13px变成10px
			this.headBody = $({className: 'chat-header-body', style: $.STYLE_BODY + 'background:#121212;z-index:0;color:#525252;'}).appendTo(this.header, true).css({
				'position': 'absolute',
			...
			this.headPic=$({tag: 'span', className:'chat-header-pic', style: $.STYLE_BODY + 'display:inline-block;margin:10px 0 0 20px;height:30px;width:122px;background:url('+ $.headerP + ') no-repeat 0 0' }).appendTo(this.headBody).html('');
			//this.headName = $({tag: 'span', className:'chat-header-name', style: $.STYLE_BODY + 'color:#ffffff;margin:10px 0px 10px 80px;display:inline-block;float:left;height:24px;line-height:24px;max-width:220px;visibility:hidden;overflow:hidden;font-weight:bold;cursor:auto;font-size:12px;color:#fff;display:none;'}).appendTo(this.headBody).html('');
...
/*				$({className: 'ntalker-button-close', style: $.STYLE_BODY + 'background:url(' + $.imageicon + ') no-repeat -80px 0;cursor:pointer;width:20px;height:20px;float:right;color:#fff;'}).appendTo(this.rightElement.find('.window-right-head')).hover(function(){
			...
			this.rightBody = $({className: 'window-right-body', style: $.STYLE_BODY + 'width:154px;background:#fafafa;'}).css({
				'border-right':  '1px solid #e4e4e4',
				'border-bottom': '1px solid #e4e4e4',
				'height':(+this.options.height - 1) + 'px',
		...
		_callResize: function(args){
           ...
           //2016.03.02 修改高度
			this.rightBody.css({
				height:(this.options.height - 41) + "px"
			});
			...
			//2016.03.02修改高度
			this.rightElement.find('.view-right-content').css({'height': (rigthConentHeight-40) + 'px'});
		...
		_addRightLabel: function(title, data, length, selected){
			...
			if( !this.rightTags ){
				...
				this.rightTags = $({className:'window-right-tags', style: $.STYLE_NBODY + 'background:#FAF9F9;z-index:-1;overflow:hidden;height:26px;border-top:2px solid #fafafa;'}).appendTo(this.rightBody);
			...
			if( $.isArray(data) ){
				...
				for(var i = 0; i < data.length; i++){
					//2016.03.02修改行高和字体颜色
					$({tag:'li', talk_title: data[i].title, talk_content: data[i].con, title: $.clearHtml(data[i].con || ''), style: $.STYLE_BODY + 'list-style:disc outside none;margin-top:5px;cursor:pointer;background-color:#FAF9F9;color:#b1b1b1;line-height:283%;'}).appendTo(listElement).html( $.clearHtml(data[i].title || '') );
					/*
		...
		_selectedTag: function(eventElement){
			...
			this.rightTags.find('[class]').each(function(i, elem){
				...
				if( $(eventElement).indexOfClass( key ) ){
					...
					$(elem).addClass('talk_selected').css({'height': '25px', 'border-bottom': 'none','font-size':'14px','font-weight':'bold','text-align':'left'});//.gradient('top', '#F8BAC2', '#F9CDDC').css('color', '#DE7E80');
