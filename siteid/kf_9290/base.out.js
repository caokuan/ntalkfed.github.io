...
;(function(window, underfined){
	...
	nTalk.extend({/*-initialize page info-*/
		...
		initializeCore: function(){
			...
			if( !nTalk.baseURI ){
				nTalk.baseURI = '../siteid/kf_9290/ntkfstat.js';
			}
...
(function($){
	$.flashserver = {
		...
		't2dstatus':'http://sh-v4.ntalker.com/t2d2/t2dstatus',
		'chatview_in':'',
		'chatview_out':'',
		'chatview_wap':'',
		'queryurl':'http://sh-v4.ntalker.com/spider/spider/',
		'tchatmqttserver':'tcp://sh-v4.ntalker.com:9044/tchat2;ws://sh-v4.ntalker.com:9045/tchat2;wss://sh-v4.ntalker.com:9046/tchat2',
		'eduimmqttserver':'',
	...
	$.sourceURI = $.baseURI + "siteid/respack/";
})(nTalk);
;(function($, undefined) {
    function emptyFunc() {}
    /**
	...
	$.base = {
		...
		start: function(){
			...
			$.require(scriptList, function(lang, module){
				...
				if( $.chatManage.open($.global.settingid, $.global.destid, $.global.itemid, $.global.itemparam, $.global.sellerid, false/*autoconnect*/, $.global.single/*single*/,'',$.global.edu_inviteid,$.global.edu_visitid) ){
					$.cache.set('opd', 1);
				}
			});
		},
		...
		_loadQueryString: function(){
			...
			$.global = $.whereGetTo($.global, target, [
				'siteid', 'sellerid', 'settingid', 'uid', 'uname', 'exparams','single','pcid','themes','backURL',
				'vip',				/*-是否是VIP用户-*/
				'ulevel',			/*-用户级别-*/
				'ref',
				'tit',
				...
				null, null, null, 'uid', 'uname','exparams','single','pcid','themes','backURL',
				'isvip',
				'userlevel',
				'source',
				'title'
